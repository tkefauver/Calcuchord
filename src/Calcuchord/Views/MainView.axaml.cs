...
namespace Calcuchord {
    ...
    public partial class MainView : UserControl {
        ...
        bool? LastRefreshWasLandscape { get; set; }
        ...
        public void RefreshMainGrid() {
            ...
            //     bool needs_clear = LastRefreshWasLandscape is not { } lrwl ||
            //                        tvm.IsLandscape != lrwl;
            //
            //     if(needs_clear) {
            ...
            //         if(Math.Abs(MainContainerGrid.ColumnDefinitions[0].Width.Value - inst_len) > double.Epsilon) {
            //             MainContainerGrid.ColumnDefinitions[0].Width = new GridLength(inst_len,GridUnitType.Auto);
            //         }
            //
            //
